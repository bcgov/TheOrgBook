...
urlpatterns = [
    ...
    url(r'^bcovrin/generate-claim-request$', search_views.VerifiableOrgSearchView.as_view()),
    url(r'^bcovrin/store-blaim$', search_views.VerifiableOrgSearchView.as_view()),
