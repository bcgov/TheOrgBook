# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-05-30 00:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=django.utils.timezone.now)),
                ('end_date', models.DateField(blank=True, null=True)),
                ('initial_credential', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='api_v2.Credential')),
            ],
            options={
                'db_table': 'subject',
            },
        ...
        migrations.AlterUniqueTogether(
            name='schema',
            unique_together=set([('name', 'version', 'publisher_did')]),
        ),
        migrations.AddField(
