# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-06-14 15:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=django.utils.timezone.now)),
                ('end_date', models.DateField(blank=True, null=True)),
                ('credentials', models.ManyToManyField(related_name='names', to='api_v2.Credential')),
            ],
            options={
                'db_table': 'name',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=django.utils.timezone.now)),
                ('end_date', models.DateField(blank=True, null=True)),
                ('credentials', models.ManyToManyField(related_name='people', to='api_v2.Credential')),
            ],
            options={
                'db_table': 'person',
            },
