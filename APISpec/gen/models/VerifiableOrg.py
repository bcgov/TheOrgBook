...
class VerifiableOrg(Auditable):	    
    ...
    orgTypeId = models.ForeignKey('VerifiableOrgType', related_name='VerifiableOrgorgTypeId')   
    jurisdictionId = models.ForeignKey('Jurisdiction', related_name='VerifiableOrgjurisdictionId')   
